...
- [Clean Code Initiative](./clean-code-initiative.md)
- Clean Code Scorer (see [Tools Reference](./tools-reference.md))
- Code Hygiene Analyzer (see [Tools Reference](./tools-reference.md))
